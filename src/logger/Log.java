...
public class Log
{
	 ...
	 * @param b name of method in which error occurred.
	 * @param c stack trace of exception
	 */
	public static void logError (String className,String b,String c) 
	{	
		LOGGER.addAppender(appender);
		LOGGER.setLevel((Level) Level.INFO);
		LOGGER.info("ClassName :"+className);
		LOGGER.info("MethodName :"+b );
		LOGGER.info("Exception :" +c);
		LOGGER.info("-----------------------------------------------------------------------------------");
	}
	...
	public static void logError(String className, boolean b, boolean c) {
